      ...
      <div className="lookbook_left_section">
        ...
        <ul className="lookbook_navbar">
          <li className="lookbook_navbar_name">
            <Link className="lookbook_link" to="/e-shop">
              e-shop
            </Link>
          </li>
          <li className="lookbook_navbar_name">
            <Link
              className="lookbook_link"
              to="/lookbook"
              style={{
                textDecoration: "underline",
                textDecorationColor: "#7d31c7",
              }}
            >
              lookbook
            </Link>
          ...
          <li className="lookbook_navbar_name">
            <Link className="lookbook_link" to="/about">
              about
            </Link>
          </li>
          <li className="lookbook_navbar_name">
            <Link className="lookbook_link" to="/news">
              news
            </Link>
          </li>
        </ul>
